...
const AccountInfoCard: React.FC<AccountInfoCardProps> = ({ className }) => {
  return (
    <div className={`${className ?? ""}`}>
      ...
      <div className="flex flex-col justify-between mt-2.5 md:mt-4 bg-white rounded-[10px] p-4 md:p-5 h-[calc(100%-44px)]">
        <div className="flex items-center border-b border-gray-300 pb-3 md:pb-[15px]">
          <Image
            src={Avatar.src}
            width={Avatar.width}
        ...
        <div className="border-t border-gray-300 pt-[18px]">
