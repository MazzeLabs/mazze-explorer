  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Menu.Items className="absolute w-[196px] left-0 mt-7 pt-3 pl-4 pr-[34px] pb-[26px] bg-white border border-gray-300 rounded-[10px]">
            {FILTERS.map((item) => (
              <Menu.Item>
                <button
      ...
      <input
        ...
        className="placeholder:text-gray-500 text-gray-700 leading-[138%] py-5 outline-none w-full mr-20"
      />
      <button className="absolute top-[3px] bottom-[3px] right-[6px] rounded-full bg-orange text-gray-700 hover:bg-dark-blue hover:text-orange transition-all p-[19px]">
