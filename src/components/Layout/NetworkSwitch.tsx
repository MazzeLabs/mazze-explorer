...
const NetworkSwitch: React.FC<NetworkSwitchProps> = ({ className }) => {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left z-20">
      ...
      >
        <Menu.Items className="absolute flex flex-col items-start max-md:left-0 md:right-0 mt-2 rounded-[10px] bg-white dark:bg-dark-blue-200 border border-[#E2E2E2] dark:border-gray-600">
          <div className="pl-2.5 pt-1">
            ...
            <Menu.Item>
              <button className="pl-2.5 pt-2.5 pb-3 pr-5 border-t border-gray-300 dark:border-gray-600 text-left group">
